    ...
    public sealed class FunctionScope : ActivationObject
    {
        ...
        private void CreateThisShortcuts()
        {
              ...
              && m_thisLiterals.Count >= 4)
            {
                ...
                // add a var to the top of the function
                m_owningFunctionObject.AddGeneratedVar("[this]", new ThisLiteral(null, Parser), true);
                ...
                foreach (ThisLiteral thisLiteral in m_thisLiterals)
                {
                    ...
                    Lookup lookup = new Lookup("[this]", thisLiteral.Context, Parser);
                    ...
                    // don't forget to analyze this node, since we already missed the initial loop
                    lookup.AnalyzeNode();
                }
            }
        }
